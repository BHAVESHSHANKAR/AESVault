...
// // 🔹 Fetch User by UniqueId (New Endpoint)
...
// // 🔹 Get Received Files (Existing Endpoint)
// router.get("/received-files/:uniqueId", async (req, res) => {
//     try {
//         const receiver = await User.findOne({ uniqueId: req.params.uniqueId });
...
router.post("/send-upload-otp", async (req, res) => {
    ...
    const mailOptions = {
        ...
        text: `Someone is trying to send you a file. Your OTP for verification is: ${otp}. Please share this with the sender. It expires in 5 minutes.`,
    };
